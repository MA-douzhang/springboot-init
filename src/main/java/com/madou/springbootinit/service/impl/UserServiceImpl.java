...
import com.madou.springbootinit.model.enums.UserRoleEnum;
import com.madou.springbootinit.model.dto.user.UserQueryRequest;
...
import com.madou.springbootinit.mapper.UserMapper;
...
import static com.madou.springbootinit.constant.UserConstant.USER_LOGIN_STATE;

/**
 * @author MA_dou
 * @description 针对表【user(用户)】的数据库操作Service实现
 * @createDate 2023-06-01 17:52:41
 */
@Service
@Slf4j
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    private final static String SALT = "madou";
