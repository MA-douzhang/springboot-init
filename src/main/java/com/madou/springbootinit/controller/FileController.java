...
import com.madou.springbootinit.constant.FileConstant;
import com.madou.springbootinit.exception.BusinessException;
import com.madou.springbootinit.model.dto.file.UploadFileRequest;
import com.madou.springbootinit.model.entity.User;
import com.madou.springbootinit.model.enums.FileUploadBizEnum;
...
public class FileController {
    ...
    public BaseResponse<String> uploadFile(@RequestPart("file") MultipartFile multipartFile,
        ...
        try {
            ...
            // 返回可访问地址
            return ResultUtils.success(FileConstant.host_dev + filepath);
        } catch (Exception e) {
